...
public class LiveSourcePcLandscapePopup extends BasePopupWindow {

    public LiveSourcePcLandscapePopup(Context context) {
        super(context);
    }

    public LiveSourcePcLandscapePopup(Context context, int width, int height) {
    ...
    public LiveSourcePcLandscapePopup setSelectedItem(int selectedItem) {
...
//        listView.setSelection(selectedItem);
    ...
    public LiveSourcePcLandscapePopup setAdapterList(List<String> list) {
