...
public class LiveSourceLandscapePopup extends BasePopupWindow {

    public LiveSourceLandscapePopup(Context context) {
        super(context);
    }

    public LiveSourceLandscapePopup(Context context, int width, int height) {
    ...
    public LiveSourceLandscapePopup setSelectedItem(int selectedItem) {
...
//        listView.setSelection(selectedItem);
    ...
    public LiveSourceLandscapePopup setAdapterList(List<String> list) {
