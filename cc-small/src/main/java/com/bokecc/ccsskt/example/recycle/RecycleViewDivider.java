...
public class RecycleViewDivider extends RecyclerView.ItemDecoration {
    ...
    private int mDividerSize = 1;//分割线高度，默认为1px
    private int mLeft = 0, mRight = 0; // 分割线左右边距 默认0
    private int mOrientation;//列表的方向：LinearLayoutManager.VERTICAL或LinearLayoutManager.HORIZONTAL
    private static final int[] ATTRS = new int[]{android.R.attr.listDivider};
    private int mType = TYPE_BETWEEN;
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        ...
        int count = mType == TYPE_BETWEEN ? childSize-1 : childSize;
        for (int i = 0; i < count; i++) {
            ...
            if (mDivider != null) {
                mDivider.setBounds(left + mLeft, top, right - mRight, bottom);
                mDivider.draw(canvas);
            }
            if (mPaint != null) {
                canvas.drawRect(left + mLeft, top, right - mRight, bottom, mPaint);
            }
        }
    }
