...
public class MallCateHorizontalListAdapter extends BaseAdapter {
    ...
    public MallCateHorizontalListAdapter(Context context, ArrayList<MallCategory> datas, int cateType) {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_mall_cate_tab_third, null);
...
//			viewHolder.groupCategoryTitle.setWidth(itemwidth);;
        ...
        if (selected.get(position)) {
            viewHolder.groupCategoryTitle.setTextColor(context.getResources().getColor(R.color.white));
            viewHolder.groupCategoryTitle.setBackground(context.getResources().getDrawable(R.drawable.shape_oval_tab_black));
        } else {
            viewHolder.groupCategoryTitle.setTextColor(context.getResources().getColor(R.color.black));
            viewHolder.groupCategoryTitle.setBackground(context.getResources().getDrawable(R.drawable.shape_oval_white));
        }
