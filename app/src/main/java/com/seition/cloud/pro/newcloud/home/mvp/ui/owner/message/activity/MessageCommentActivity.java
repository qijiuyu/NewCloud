...
public class MessageCommentActivity extends BaseActivity<MessagePresenter> implements MessageContract.View {
    ...
    public int initView(Bundle savedInstanceState) {
        return R.layout.activity_message_comment; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
