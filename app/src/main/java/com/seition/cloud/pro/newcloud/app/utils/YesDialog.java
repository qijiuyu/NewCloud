...
/**
 * Created by addis on 2017/10/26.
 */
...
public class YesDialog extends Dialog {
    ...
    public YesDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public YesDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final YesDialog dialog = new YesDialog(context,R.style.dialog_style);
            View layout = inflater.inflate(R.layout.dialog_yes_layout, null);
