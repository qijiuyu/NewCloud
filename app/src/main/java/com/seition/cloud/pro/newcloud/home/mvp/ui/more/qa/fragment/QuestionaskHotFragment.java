...
public class QuestionaskHotFragment extends BaseBackFragment<QuestionaskPresenter> implements QuestionaskContract.View ,BaseQuickAdapter.OnItemClickListener{
...
//    StatusView mStatusView;
    ...
    public static QuestionaskHotFragment newInstance( ) {
        Bundle args = new Bundle();

        QuestionaskHotFragment fragment = new QuestionaskHotFragment();
        return fragment;
    }
    ...
    public View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_question_hot, container, false);
        return view;
    }
...
//        springView.setFooter(new DefaultFooter(getActivity()));
    ...
    private void loadData(){
        mPresenter.getWeekHotQuestions();
    }
