...
public abstract class CustomShapeImageBase extends ImageView {
	 private static final String TAG = CustomShapeImageBase.class.getSimpleName();
	    ...
	    public CustomShapeImageBase(Context context) {
	        super(context);
	        sharedConstructor(context);
	    }

	    public CustomShapeImageBase(Context context, AttributeSet attrs) {
	        super(context, attrs);
	        sharedConstructor(context);
	    }

	    public CustomShapeImageBase(Context context, AttributeSet attrs, int defStyle) {
