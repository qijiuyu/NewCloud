...
import com.seition.cloud.pro.newcloud.home.mvp.ui.public_adapter.ExamCategoryListAdapter;
...
public class ExamCategoryPickPopupWindow extends BasePopWindow implements View.OnClickListener {
    ...
    private TestClassify mSelectedProvince;
    private TestClassify mSelectedCity;
    private TestClassify mSelectedArea;

    private ArrayList<TestClassify> firstDatas = new ArrayList<>();
    private ArrayList<TestClassify> secondDatas = new ArrayList<>();
    private ArrayList<TestClassify> thirdDatas = new ArrayList<>();

    private Map<String, TestClassify> provinceMap = new HashMap<String, TestClassify>();
    private Map<String, ArrayList<TestClassify>> cityMap = new HashMap<String, ArrayList<TestClassify>>();
    private Map<String, ArrayList<TestClassify>> areaMap = new HashMap<String, ArrayList<TestClassify>>();

    public ExamCategoryPickPopupWindow(Activity activity, ArrayList<TestClassify> firstData/*, Map<String, ArrayList<CommonCategory>> secondDatas, Map<String, ArrayList<CommonCategory>> areaMap*//*, String selected*/) {
        super();
...
//        popupWindow.setTouchable(true);
    ...
    ExamCategoryListAdapter firstListAdapter;
    ExamCategoryListAdapter seconListAdapter;
    ExamCategoryListAdapter thirdListAdapter;

    private void initWheelView() {
        firstListAdapter = new ExamCategoryListAdapter(activity, firstDatas, false, R.color.white);
        seconListAdapter = new ExamCategoryListAdapter(activity, secondDatas, false, R.color.white);
        thirdListAdapter = new ExamCategoryListAdapter(activity, thirdDatas, false, R.color.white);
