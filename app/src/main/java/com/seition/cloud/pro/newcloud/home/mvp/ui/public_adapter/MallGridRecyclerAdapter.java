...
public class MallGridRecyclerAdapter extends BaseQuickAdapter<Mall, BaseViewHolder> {

    public MallGridRecyclerAdapter() {
        super(R.layout.item_mall_grid_list);
    }

    @Override
    protected void convert(BaseViewHolder viewHolder, Mall bean) {
        viewHolder.setText(R.id.mall_name, bean.getTitle());
        viewHolder.setText(R.id.mall_intro, bean.getInfo());
        ...
        GlideLoaderUtil.LoadImage(viewHolder.itemView.getContext(), bean.getCover(), (ImageView) viewHolder.getView(R.id.mall_cover));
    }
