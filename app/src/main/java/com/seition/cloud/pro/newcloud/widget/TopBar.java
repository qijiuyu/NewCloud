...
public class TopBar extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        addView(mTabLayout, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Utils.dip2px(context, 45f)));//ViewGroup.LayoutParams.MATCH_PARENT
    ...
    public TopBar addItem(final TopBarTab tab) {
...
//        tab.setTabPosition(mTabLayout.getChildCount());
    ...
    public interface OnTabSelectedListener {
        void onTabSelected(int position, int prePosition, TopBarTab tab);
